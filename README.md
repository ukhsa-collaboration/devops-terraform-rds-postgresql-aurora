...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_cluster"></a> [cluster](#module\_cluster) | terraform-aws-modules/rds-aurora/aws | 10.2.0 |
...
| <a name="input_enable_control_tower_backup_daily"></a> [enable\_control\_tower\_backup\_daily](#input\_enable\_control\_tower\_backup\_daily) | Enable Control Tower daily backup tag on the cluster. | `bool` | `true` | no |
| <a name="input_enable_control_tower_backup_hourly"></a> [enable\_control\_tower\_backup\_hourly](#input\_enable\_control\_tower\_backup\_hourly) | Enable Control Tower hourly backup tag on the cluster. | `bool` | `true` | no |
| <a name="input_enable_control_tower_backup_monthly"></a> [enable\_control\_tower\_backup\_monthly](#input\_enable\_control\_tower\_backup\_monthly) | Enable Control Tower monthly backup tag on the cluster. | `bool` | `true` | no |
| <a name="input_enable_control_tower_backup_weekly"></a> [enable\_control\_tower\_backup\_weekly](#input\_enable\_control\_tower\_backup\_weekly) | Enable Control Tower weekly backup tag on the cluster. | `bool` | `true` | no |
